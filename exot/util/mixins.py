...
class Serialisable(metaclass=abc.ABCMeta):
    ...
    def __init_subclass__(
        cls,
        # serialise_ignore: t.List[str] = [],
        # serialise_stub: t.List[str] = [],
        # serialise_no_parent: bool = True,
        # serialise_inherit: bool = True,
        # serialise_io_type: str = "text",
        **kwargs,
    ):
...
class IntermediatesHolder(metaclass=abc.ABCMeta):
    def __init_subclass__(cls, **kwargs):
        ...
        if mro_hasattr(cls, "_serialise_to_save"):
            cls._serialise_to_save.add("intermediates")
...
class IntermediatesCollector(IntermediatesHolder):
    @staticmethod
