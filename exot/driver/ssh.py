...
A backend for SSH connections.

Synopsis & signatures::

_wrapper              (self, f: Callable, cmd: Union[List[str], str], **kwargs: Any) -> invoke.runners.Result
can_connect           (self) -> bool
connect               (self) -> None
disconnect            (self) -> None
instantiate           (*args, **kwargs) -> 'object'
required_config_keys  () -> List[str]
run                   (self, cmd: Union[List[str], str], **kwargs: Any) -> invoke.runners.Result
sudo                  (self, cmd: Union[List[str], str], **kwargs: Any) -> invoke.runners.Result
