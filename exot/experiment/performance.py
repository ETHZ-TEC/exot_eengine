...
from ._mixins import CCIStreams, CCOStreams
...
class PerformanceRun(
    ...
    def write(self) -> None:
        ...
        In addition to the base class'es `write`, the PerformanceRun als0 writes an
    ...
    @property
    def estimated_duration(self) -> t.Optional[float]:
